        ...
        <div class="content">
            ...
            <div class="document-card">
                <div style="margin-bottom: 16px;">
                    <img src="https://firmalegalonline.com/img/Nuevologo.jpg" alt="Documento" style="width:40px;height:auto;border-radius:6px;opacity:0.8;" />
                </div>
                <h3>${documentTitle || 'Documento'}</h3>
            </div>
            <div style="text-align: center; margin: 36px 0;">
                <a href="${signatureUrl}" class="btn-sign" style="display: inline-block; background: #2a0d31; color: #FFFFFF; padding: 16px 48px; text-decoration: none; border-radius: 999px; font-weight: 700; font-size: 16px; letter-spacing: 0.3px;">Revisar y Firmar</a>
            </div>
